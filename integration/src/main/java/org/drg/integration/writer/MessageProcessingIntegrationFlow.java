package org.drg.integration.writer;

import java.io.File;
import java.time.LocalDateTime;
import java.time.format.DateTimeFormatter;

import org.drg.integration.configuration.ApplicationConfiguration;
...
public class MessageProcessingIntegrationFlow {
     ...
     */
    @Bean
    public IntegrationFlow writeToFile(@Qualifier(FILE_WRITING_MESSAGE_HANDLER) MessageHandler fileWritingMessageHandler) {
